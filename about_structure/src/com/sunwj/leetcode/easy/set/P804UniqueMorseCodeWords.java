package com.sunwj.leetcode.easy.set;//国际摩尔斯密码定义一种标准编码方式，将每个字母对应于一个由一系列点和短线组成的字符串， 比如: "a" 对应 ".-", "b" 对应 "-...", "c
//" 对应 "-.-.", 等等。
//
...
public class P804UniqueMorseCodeWords{
    public static void main(String[] args) {
        ...
        System.out.println(solution.uniqueMorseRepresentations(testStr));
    }
